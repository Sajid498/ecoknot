...
import { categoryLabels, currency, Fund, getFunds } from "@/lib/fundraising";
...
export default function FundraisingPage() {
  ...
  return <main className="min-h-screen bg-slate-50"><Navbar /><section className="mx-auto max-w-7xl px-6 py-10">
    ...
    {visible.length === 0 && <div className="mt-8 rounded-2xl bg-white p-10 text-center text-slate-500 shadow-sm">No approved campaigns yet. New campaigns appear here after review.</div>}
  </section></main>;
}
